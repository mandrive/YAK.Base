    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Question_Id, t.Vote_Id })
                .ForeignKey("dbo.Question", t => t.Question_Id)
                .ForeignKey("dbo.Vote", t => t.Vote_Id)
                .Index(t => t.Question_Id)
                .Index(t => t.Vote_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.QuestionVote", "Vote_Id", "dbo.Vote");
            DropForeignKey("dbo.QuestionVote", "Question_Id", "dbo.Question");
            ...
            DropIndex("dbo.QuestionVote", new[] { "Vote_Id" });
            DropIndex("dbo.QuestionVote", new[] { "Question_Id" });
